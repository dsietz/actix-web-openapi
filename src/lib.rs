...
pub fn from_path<P>(path: P) -> Result<spec::Spec>
where
    P: AsRef<Path>,
{
...
pub fn from_reader<R>(read: R) -> Result<spec::Spec>
where
    R: Read,
{
    Ok(serde_yaml::from_reader::<R, spec::Spec>(read)?)
}

/// serialize to a yaml string
pub fn to_yaml(spec: &spec::Spec) -> Result<String> {
    Ok(serde_yaml::to_string(spec)?)
}

/// serialize to a json string
pub fn to_json(spec: &spec::Spec) -> Result<String> {
